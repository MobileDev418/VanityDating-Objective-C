...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.notificationDisplayDuration = 0.6f;
        self.dismissInterval = 1.f;
        ...
        _notificationQueue = [[NSMutableArray array] retain];
...
- (void)postNotificationMessage:(OTNotificationMessage *)message
{
    ...
    [_notificationQueue addObject:[message retain]];
